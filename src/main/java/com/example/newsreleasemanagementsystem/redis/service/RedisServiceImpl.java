package com.example.newsreleasemanagementsystem.redis.service;
...
@Service
public class RedisServiceImpl<T> implements RedisServise<T> {
    ...
    @Override
    public Long getExpire(String key, long time) {
